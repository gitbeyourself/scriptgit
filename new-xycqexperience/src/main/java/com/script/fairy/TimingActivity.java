...
//                    return;
                ...
                if (result2.sim>0.8f){
                    ...
                    if (x11>=2) {
                        ...
                        mFairy.onTap(0.8f, result3, 1036, 188, 1274, 364, "选择对手", Sleep);
                        x12=1;
                        x11=0;
                    }else {
                        x12=0;
                    ...
                    if ((result.sim >0.7f|| result1.sim>0.8f) || x12!=0){
                        ydcount=0;
...
/*
                ...
                result =mFairy.findPic(546,1,742,49,new String[]{"startGame.png","startGame1.png","bsks.png"});
                if (result.sim>0.8f){
