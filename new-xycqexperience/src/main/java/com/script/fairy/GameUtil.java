...
*/
            ...
            public void content_1() throws Exception {
                ...
                result = mFairy.findPic(47,40,290,357,new String[]{"Activeinterface.png","Activeinterface1.png","Activeinterface2.png","Activeinterface3.png","Activeinterface4.png"});
        ...
        new GameUtil(mFairy) {
            ...
            public void content_0() throws Exception {
                ...
                for (int i = 0; i < j; i++) {
                    ...
                    mFairy.onTap(0.8f,result,"关前叉",500);
                    ...
                    result=mFairy.findPic(443,224,1108,533,"cha3.png");
                    mFairy.onTap(0.9f,result,"关叉3",500);

                    result1=mFairy.findPic(1040,6,1277,132,new String[]{"cha10.png","bxcha.png","bxcha1.png"});
                    mFairy.onTap(0.9f,result1,"关叉11",800);

                    result1=mFairy.findPic(443,224,1108,533,"zuocecha.png");
                    mFairy.onTap(0.9f,result1,"关叉左",500);

                    result = mFairy.findPic(404,1,1279,300, new String[]{"cha4.png","cha8.png","chawq.png","cha6.png","cha2.png","cha.png","quxiao.png","fork.png","fork1.png","cha5.png"});//"ymzjcha.png",
                    mFairy.onTap(0.8f, result, "关叉", 500);

                    result = mFairy.findPic(443,224,1108,533, new String[]{"cha4.png","cha6.png","cha2.png","cha.png","quxiao.png","fork.png","fork1.png","cha5.png"});//"ymzjcha.png",
                    mFairy.onTap(0.8f, result, "关叉", 500);
    ...
    new GameUtil(mFairy) {
        ...
        public void content_5() throws Exception {
            ...
            if(AtFairyConfig.getOption("zhsz").equals("1")){
                ...
                result = mFairy.findPic(1088,461,1158,539,new String[]{"qhTotems.png", "tuteng.png"});
                LtLog.e("x="+x++);
                if(result.sim > 0.8f){
                    mFairy.onTap(0.8f, result, "图腾", Sleep);
                    x=0;
        ...
        public void content_6() throws Exception {
            ...
            result = mFairy.findPic(415,11,876,284,"bsyn.png");
            if (result.sim > 0.8f) {
                mFairy.initMatTime();
                setTaskName(5);return;
            }
...
/*            if (dazeTime>10 ){
                result = mFairy.findPic(876, 5, 1120, 146, "daily.png");
                mFairy.onTap(0.8f, result, 851, 594, 866, 604, "下车", Sleep);
                mFairy.onTap(0.8f, result, 577,406,618,446, "点击传送npc", 2000);
                result = mFairy.findPic(52,347,501,482, "hdxm.png");
                mFairy.onTap(0.8f, result, "回到血盟", 3000);
            }*/
        ...
        public void content_11() throws Exception {
            ...
            result = mFairy.findPic(940,3,1136,93, "daily1.png");
            mFairy.onTap(0.8f, result, 1181, 71, 1203, 90, "打开地图", Sleep);
            ...
            public void content_1() throws Exception {
                ...
                if (result.sim > 0.8f) {
                    ...
                    switch (str) {
                        ...
                        case "112":                     //氏族焚天台2层
                            LtLog.e("氏族焚天台2层");
                            x=gmx *-1.5399+gmy *-0.0047+693.0637;
                            y=gmx *0.0139+gmy *-1.5308+625.1957;
                            break;
                        case "113":                     //氏族焚天台三层
                    ...
                    if (str.equals("111")){
                        ...
                        if (LimitlessTask.szmap==2){
                            //天外噬灵渊一层
                            x=gmx *2.3849+gmy *-0.0132+170.5275;
                            y=gmx *-0.0156+gmy *2.3962+83.6777;
                        }
        ...
        new GameUtil(mFairy){
            ...
            public void content_1() throws Exception {
                ...
                if (result.sim>0.8f){
                    ...
                    /*result = mFairy.findPic(600,146,1137,529,"lyd.png");
                    if (result.sim>0.8f) {
                        mFairy.onTap(0.8f, result, "凌元丹", 500);
                    ...
                    result = mFairy.findPic(600,146,1137,529,new  String[]{"yinpiao.png","jinpiao.png","jinpiao2.png","buluo bi2.png","daizi.png"});
                    mFairy.onTap(0.8f, result, "物品", 1000);
                    ...
                    if (result.sim>0.8f && result1.sim <0.8f){
                        ...
                        result = mFairy.findPic(430,86,859,235,new String[]{"cishuxianzhi.png","wfsy.png"});
                        mFairy.onTap(0.8f, result, 915,153,934,167,"次数限制",Sleep);
                        if (result.sim>0.8f){
                            mFairy.ranSwipe(1106,309, 629,301, 1000, (long) 1500,2);
                        }else {
