...
public class Abnormal extends TaskContent {
    ...
    public void erro() throws Exception {
        ...
        result = mFairy.findPic(302,551,459,669,"checkvx.png");
        if (result.sim > 0.8f) {

            switch (AtFairyConfig.getOption("qdl")) {
                case "1":
                    mFairy.onTap(0.8f, result, 851,611,858,617, "errvx登录界面_QQ登录", Sleep);
                    break;
                case "2":
                    mFairy.onTap(0.8f, result, 462,611,474,619,"errvx登录界面_微信登录", Sleep);
                    break;
            }
        }
...
//        mFairy.onTap(0.8f, result, "err开始游戏", 10000);
        ...
        result = mFairy.findPic(409,505,884,657,new String[]{"Getintogame1.png","Getintogame2.png","Getintogame3.png","Getintogame4.png","Getintogame5.png"});
        mFairy.onTap(0.8f, result, "err开始游戏", 10000);
        ...
        mFairy.onTap(0.8f, result, 1213,39,1220,55, "err左侧弹窗邮件关闭", Sleep);
