...
public class TaskMain {
     ...
     public  TaskMain (AtFairyImpl ypFairy) throws Exception {
         mFairy = ypFairy;
         mFairy.setGameName("新轩辕传奇");
         mFairy.setGameVersion(655);
     ...
     public void main() throws Exception {
         /*for (int i=0;i<100;i++){
             Thread.sleep(10000);
            //LtLog.e("cpu====="+singleTask.getAppCpuUsedPercent());
         }*/
         ...
         switch (task_id) {
             ...
             case 1937:
                 ...
                 if (AtFairyConfig.getOption("5193").equals("1")){
