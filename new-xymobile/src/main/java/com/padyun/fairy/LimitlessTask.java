...
public class LimitlessTask extends TaskContent {
    ...
    public void inOperation() throws Exception {
        ...
        result = mFairy.findPic(new String[]{"In transmission.png","In transmission1.png"});
        if (result.sim > 0.7f) {
    ...
    public void fieldHangMachine() throws Exception {
        new LimitlessTask(mFairy) {
            int gmx = 0, gmy = 0, num = 1, yhsr = 0;//地图
            String img = "";
            ControlSplit back =null,qb = null, sjbs = null, sywp = null, lctx = null, lgz = null, scsj = null;
            ...
            public void content_1() throws Exception {
                ...
                result = mFairy.findPic(new String[]{"qhTotems.png","tuteng.png"});
            ...
            public void content_3() throws Exception {
                ...
                if (result.sim > 0.8f) {
                    ...
                    mFairy.condit();
                    for (int i = 1; i < 13; i++) {
                        result = mFairy.findPic("gjdigong" + i + ".png");
                        if (result.sim > 0.9f) {
                            switch (i) {
                                case 1:
                                ...
                                case 11:
                                    ...
                                    break;
                                case 12:
                                    LtLog.e(mFairy.getLineInfo("山海界"));
                                    tu1 = 12;
                                    break;
                            }
                            break;
            ...
            public void content_5() throws Exception {
                ...
                if (result.sim > 0.8f) {
                    ...
                    if (ceng2 > 0) {
                        ...
                        if ((tu == 1 || tu == 2 || tu == 3 || tu == 6 || tu == 7 || tu == 8 || tu == 10) && ceng1 == 1) {
                            mFairy.tap(779, 176);
    ...
    public void sevenStar() throws Exception {
        new LimitlessTask(mFairy) {
            ...
            /*    result = mFairy.findPic(18, 116, 532, 607, "zuoceTreasure.png");
                ...
                if (result1.sim > 0.8f) {
                    mFairy.taskSlid(err, new int[]{0, 2, 4, 6}, 0, 228, 557, 228, 282, 500, 1500, 2);
                }
    ...
    public int taskand() throws Exception {
        ...
        if (AtFairyConfig.getOption("qxlb").equals("1") && AtFairyConfig.getOption("xmqj").equals("1") && (!LimitlessTask.this.eliminate || !LimitlessTask.this.sevenStar)) {
            ...
            if (result.sim > 0.8f) {
                mFairy.taskSlid(lbcount, new int[]{0, 2, 4, 6 ,8,10,12,14}, 0, 76, 426, 76, 245, 500, 1500, 2);
            } else {
                lbcount = 0;
            }
            if (lbcount > 14) {
