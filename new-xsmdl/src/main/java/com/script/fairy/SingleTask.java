...
//                }
                ...
                result = mFairy.findPic(529,590,753,627,"qiyue.png");
                mFairy.onTap(0.8f, result, 622,519,665,573, "激活契约", Sleep);
                ...
                mFairy.onTap(0.8f, result, 918, 640, 936, 653, "前往挑战", 2000);
...
//                            LtLog.e("*//*******//*" + (result1.x + 142) + "," + (result1.y - 155) + "," + (result1.x + 207) + "," + (result1.y - 118));
    ...
    /**
     * 日常 要塞任务  count 3次进行关闭 可能会多出其他工会任务
     *
     * @throws Exception
     */
