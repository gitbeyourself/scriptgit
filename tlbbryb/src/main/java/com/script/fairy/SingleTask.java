    ...
    public void gangsAlchemy()throws Exception {
        new SingleTask(mFairy) {
            ...
            public void content_3() throws Exception {
                ...
                result = mFairy.findPic(54,853,345,897,"Gold mining.png");
                mFairy.onTap(0.8f,result,"挖掘金矿",2000);
                err=0;
    ...
    public void collection() throws Exception{
        new SingleTask(mFairy){
            ...
            public void content_1() throws Exception {
                ...
                result = mFairy.findPic(new String[]{"Skill2.png","Skill2s.png","jineng.png"});
                mFairy.onTap(0.7f,result,421,134,474,167,"采集栏",2000);
