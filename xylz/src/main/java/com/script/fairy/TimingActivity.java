            ...
            public void content_1() throws Exception {
                ...
                if(!fangsheng){
                    ...
                    if(result.sim>0.8&&result1.sim<0.8){
                        ...
                        if(result.sim<0.8f){
                            result=mFairy.findPic("call once.png");
                            if(result.sim>0.8f){
                                //没有免费字
                                result=mFairy.findPic(280,563,326,587,"call pet free.png");
                                if(result.sim<0.8){
...
//                    }else not_fight=0;
                    ...
                    try{
                        //在安全区
                        result=mFairy.findMultiColor(1122,150,1149,174,0.95f,"82,234,60",
                                "4|0|79,231,54&7|0|85,254,53&10|0|79,232,55&-1|5|83,228,65&4|5|84,252,53&8|5|78,223,56&12|5|78,225,58&2|8|84,246,55&10|8|80,234,54");
                    }catch(Exception e){
                        LtLog.e(mFairy.getLineInfo("获取出错"));
                        LtLog.e(mFairy.getLineInfo(e.getMessage()));
                    }
            ...
            public void content_1() throws Exception {
                ...
                if(result.sim>0.8f) {
                    ...
                    try{
                        ...
                        //升级的红点
//                    result=mFairy.findMultiColor(1143,592,1168,617,0.9f,"206,69,69",
//                            "2|0|205,68,68&4|0|211,64,64&6|0|211,64,64&-1|2|217,66,67&2|2|212,66,66&5|2|212,66,65&8|2|212,71,70&0|4|215,72,72&3|4|210,68,67");
//                    mFairy.onTap(0.8f,result,1075,633,1080,639,"升级",1000);
