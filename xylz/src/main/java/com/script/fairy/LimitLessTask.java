...
//                    result1=mFairy.findPic(1114,112,1244,173,"ceng.png");
                ...
                if(tower==0){
                    ...
                    if (result.sim>0.8){
                        ...
                        while(mFairy.condit()){
                            result=mFairy.findPic("chuansong1.png");
                            if(result.sim<0.8f){
                                LtLog.e("222222");
                                setTaskName(3);
                                openMap=true;
            ...
            public void content_3() throws Exception{
                ...
                if(result.sim>0.9f||result1.sim>0.9f){
                    //判断地图对不对
                    if(place>=20&&place<=23){
                        //云天界
                        result1=mFairy.findPic(1080,4,1166,31,"word place "+placeName+".png");
                    }else if (place>=65&&place<=66){
                        //result1=mFairy.findPic(1114,112,1244,173,"ceng.png");
                    }else {
                        result1=mFairy.findPic(1086,4,1236,32,"word place "+placeName+".png");
                    }
                    LtLog.e("相似度"+result1.sim);
                    if(result1.sim<0.75f){
                ...
                //地图界面
                result=mFairy.findPic("world map.png");
                picCount=picCount(0.8f,result,"world map");
...
//                        mFairy.onTap(coord_x,coord_y,coord_x+1,coord_y+1,"点击屏幕坐标前往2",1000);
                    ...
                    //和平模式
                    if(peace){
                        result=mFairy.findMultiColor(169,69,185,91,0.9f,"191,189,198",
                                "1|1|183,180,190&2|2|176,173,183&4|3|158,155,167&5|5|158,154,167&4|7|173,170,181&3|8|170,167,179&2|9|174,171,182&1|10|175,172,183&0|12|182,179,189");
                        if(result.sim>0.85f){
//                            result=mFairy.findMultiColor(117,67,159,93,0.9f,"13,212,90",
//                                    "0|4|6,226,89&5|1|19,202,91&16|0|23,194,92&22|0|11,216,90&28|0|20,198,91&15|8|19,201,91&22|8|6,227,89&29|8|15,209,90&22|13|11,217,90");
