    ...
    public void xyrw() throws Exception {
        new SingleTask(mFairy) {
            ...
            /*    result = mFairy.findPic("closehand.png");
                ...
                result = mFairy.findPic(22,491,1227,665,"xyjiequle.png");
                if (result.sim > 0.92f) {
                    mFairy.onTap(0.92f, result, 1227, 28, 1245, 43, "仙缘已接取了", Sleep);
                    setTaskName(2);
                    return;
                }
               ...
               /* result = mFairy.findPic("caiyicai.png");
                mFairy.onTap(0.8f, result, "踩一踩", Sleep);
                if (result.sim > 0.8f) {
                    gameUtil.close(1);
                }*/
...
/*
              ...
              /*  result = mFairy.findPic(394, 161, 1183, 673, "xycyc.png");
                mFairy.onTap(0.8f, result, "空间任务打开空间", Sleep);
    ...
    public void lqhx()throws Exception{
        ...
        new SingleTask(mFairy){
            ...
            public void content_2() throws Exception {
                ...
                result = mFairy.findPic("hui3.png");
                if(result.sim>0.8f){
                    err=0;
