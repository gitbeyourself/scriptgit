...
public class GameUtil extends TaskContent {
    ...
    public void close(final int close) throws Exception {
        ...
        for (int i = 0; i < j; i++) {
            ...
            result = mFairy.findPic(492, 12, 1272, 334, new String[]{"fork.png", "fork3.png","cha1.png"});
    ...
    public void clearBag() throws Exception {
        new GameUtil(mFairy) {
            ...
            public void content_2() throws Exception {
                ...
                result = mFairy.findPic("baginface.png");
                if (result.sim > 0.8f) {
                    result = mFairy.findPic("huishou.png");
                    mFairy.onTap(0.8f, result, "回收", 3000);

                    result = mFairy.findPic("huishou1.png");
            ...
            public void content_3() throws Exception {
                ...
                if (result.sim > 0.8f) {
                    LtLog.e(mFairy.getLineInfo("包裹界面中"));
                    result = mFairy.findPic(761, 177, 1147, 570, new String[]{"wupin1.png", "wupin2.png", "wupin3.png", "wupin4.png", "wupin5.png", /*"wupin6.png",*/ "wupin7.png", "wupin8.png", "xyd1.png", "xyd3.png"});
            ...
            public void content_1() throws Exception {
                ...
                if (result.sim > 0.8f) {
                    ...
                    if (result.sim > 0.8f) {
                        for (int i = 0; i < 20; i++) {
                            mFairy.condit();
                            result = mFairy.findPic(298,217,1194,484,  new String[]{"Sign in.png","Sign in1.png","Sign in2.png"});
                            mFairy.onTap(0.8f, result, "签到", 100);
                            mFairy.onTap(0.8f, result, 1083, 136, 1101, 148, "签到", 100);
                        }
                        setTaskName(2);
                        return;
                    }
